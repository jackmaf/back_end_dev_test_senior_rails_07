    ...
    class Payments < Grapes::API
      ...
      resource :payments do
        ...
        post do
          ...
          pnv = PaymentNewValidate.new
          pnv = pnv.call(declared_params)
          if pnv.success?
            p = Payment.create!(declared_params)
            { response: "Successfully created payment!", payment: p}
          else
            { error: pnv.errors.first.to_s}
          end
        end
        ...
        route_param :id do
          put do
            p = Payment.find(params[:id])
            p.update!(declared(params).reject{|_, v| v.blank?})
